...
- ⚡️ **Nuxt UI** [UI]
(https://github.com/nuxt/ui)(https://ui4.nuxt.com/templates)(https://ui4.nuxt.com/docs/getting-started/installation/nuxt)
...
- ⚡️ **Drizzle** [ORM]
(https://orm.drizzle.team/docs/get-started-sqlite)(https://orm.drizzle.team/docs/guides)(https://orm.drizzle.team/docs/get-started/sqlite-new)(https://orm.drizzle.team/docs/guides/timestamp-default-value)
demo(https://orm.drizzle.team/docs/sql-schema-declaration)
enum(https://github.com/drizzle-team/drizzle-orm/discussions/1914)
uuid(https://github.com/drizzle-team/drizzle-orm/issues/2611)
